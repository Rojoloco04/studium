      ...
      <div className="surface-border rounded-xl p-5">
        ...
        <ol className="space-y-2 text-sm text-[var(--text-dim)]">
          <li className="flex gap-2">
            ...
            Open Canvas → <strong className="text-[var(--text)]">Account → Settings</strong>
          </li>
          <li className="flex gap-2">
            <span className="font-mono text-[var(--accent)] flex-shrink-0">2.</span>
            Scroll to <strong className="text-[var(--text)]">Approved Integrations</strong> → <strong className="text-[var(--text)]">+ New Access Token</strong>
          </li>
          <li className="flex gap-2">
            <span className="font-mono text-[var(--accent)] flex-shrink-0">3.</span>
            Name it <strong className="text-[var(--text)]">Studium</strong>, set an expiry, copy the token
          </li>
        </ol>
        <a
